                ...
                <div class="card">
                    <div class="card-header pt-3">
                        <div class="row invoice-info justify-content-center text-center">
                            ...
                            <h1 class="h5 mb-3"><strong> Employee Detail</strong></h1>

                                <div class="profile">
                                    <img src="{{ asset('admin-assets/img/logo.png')}}" alt="logo" class="brand-image img-circle elevation-4" style="height: 5cm "><br>
